...
df.drop(['Address','Listing URL','Listing Agent','MLS ID','Days on Market'],axis=1,inplace=True)
...
# df=df.drop(['City','State','Property Type','MLS ID','Listing Agent','Status','Zipcode','MLS ID_encoded','Property Type_encoded','Listing Agent_encoded','State_encoded','Status_encoded'],axis=1)
print(df.info())
print(df.head())
print(df.nunique())
...
cols=['Price','Bedrooms','Bathrooms','Area (Sqft)','Lot Size','Year Built']
